        ...
        <div class="flex-1 flex flex-col min-w-0 h-full overflow-hidden">
            ...
            <main class="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-10 space-y-6">
                <div>
                    ...
                    <p class="text-xs text-slate-400 mt-0.5">Scholarship Admin / office accounts registered in the
                        system. To create or deactivate an account, contact your Super Admin.</p>
                </div>
                            ...
                            <tbody class="divide-y divide-slate-100 text-xs font-semibold">
                                @forelse($officers as $officer)
                                    <tr class="hover:bg-slate-50/40 transition">
                                        ...
                                        <td class="py-4 px-6">
                                            <span
                                                class="px-2.5 py-1 rounded-lg text-[10px] font-extrabold uppercase {{ ($officer->status ?? 'Active') === 'Active' ? 'bg-emerald-50 text-emerald-700 border border-emerald-100' : 'bg-slate-100 text-slate-500 border border-slate-200' }}">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="py-12 text-center text-slate-400 font-medium">No office
                                            accounts found.</td>
                                    </tr>
                                @endforelse
                            </tbody>
