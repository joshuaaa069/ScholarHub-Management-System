...
<head>
    ...
    <title>School Registrar Dashboard - CKC ScholarHub</title>
...
<body class="font-sans antialiased h-full text-slate-800"
    ...
    <div x-show="mobileSidebarOpen" class="fixed inset-0 z-50 flex md:hidden" role="dialog" aria-modal="true"
        style="display: none;">
        <!-- Backdrop -->
        ...
        <div x-show="mobileSidebarOpen" x-transition:enter="transition ease-in-out duration-300 transform"
            ...
            <div class="flex flex-shrink-0 items-center px-4 gap-3">
                <div
                    class="w-10 h-10 rounded-lg bg-white flex items-center justify-center overflow-hidden shrink-0 shadow-sm">
            ...
            <div class="mt-5 h-0 flex-1 overflow-y-auto px-2 space-y-1">
                <nav class="space-y-1.5 px-2">
                    <a href="{{ route('superadmin.dashboard') }}"
                        class="flex items-center gap-3 px-4 py-3 rounded-xl bg-slate-800/55 text-white font-semibold transition-all">
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 flex flex-col min-w-0">
            ...
            <header
                ...
                <div class="relative w-full max-w-xs hidden sm:block">
                    ...
                    <input type="text" placeholder="Search..."
                        class="w-full pl-10 pr-4 py-2 bg-slate-50 border border-slate-200 focus:bg-white focus:border-brand-500 rounded-xl text-xs outline-none transition-all">
                </div>
                ...
                <div class="flex items-center gap-4 ml-auto">
                    <button
                        ...
                        <span
                            class="absolute top-2.5 right-2.5 w-2 h-2 rounded-full bg-blue-500 border-2 border-white"></span>
                    </button>
            ...
            <main class="flex-1 overflow-y-auto p-6 md:p-8 space-y-6">
                ...
                <div>
                    <h2 class="text-2xl font-extrabold text-slate-900 tracking-tight">Registrar Overview</h2>
                    <p class="text-sm text-slate-500 mt-1">Student verification and application review workflow.</p>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                    ...
                    <!-- Total Users -->
                    <div
                        class="bg-white rounded-2xl border border-slate-100 p-5 flex flex-col justify-between shadow-sm min-h-[140px]">
                    ...
                    <div
                        ...
                        <div class="text-[11px] text-slate-400 mt-4">Active Registrar Accounts</div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="flex items-start justify-between">
                            <div>
                                ...
                                <h3 class="text-2xl font-extrabold text-slate-900 mt-1">
                                    {{ number_format($totalScholarships ?? 0) }}
                                </h3>
                            </div>
                            <div
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <!-- Graph Container -->
                    <div
                        class="lg:col-span-2 bg-white rounded-2xl border border-slate-100 shadow-sm p-6 flex flex-col justify-between">
                        ...
                        <div class="relative w-full h-[320px] flex items-end">
                            <div
                                class="absolute inset-0 flex flex-col justify-between text-slate-300 pointer-events-none pb-8 text-[11px] font-medium">
                            ...
                            <svg class="absolute inset-x-0 bottom-8 h-[240px] w-full pr-4 pl-10" viewBox="0 0 100 100"
                                ...
                                <path
                                    d="M 0,68 C 15,64 15,55 33,52 C 45,50 55,60 67,54 C 80,48 85,30 100,48 L 100,100 L 0,100 Z"
                                    fill="url(#chart-glow)"></path>
                                <path d="M 0,68 C 15,64 15,55 33,52 C 45,50 55,60 67,54 C 80,48 85,30 100,48"
                                    fill="none" stroke="#10b981" stroke-width="2" stroke-linecap="round"></path>
                            </svg>

                            <div
                                class="absolute bottom-0 left-10 right-0 flex justify-between text-xs font-semibold text-slate-400">
                                <span>Jan</span>
                                <span>Feb</span>
                                <span>Mar</span>
                                <span>Apr</span>
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <div class="space-y-3">
                                ...
                                <!-- Create Admin -->
                                <a href="{{ route('superadmin.usermanage') }}?create=1"
                                    class="flex items-center gap-3 w-full px-5 py-3.5 rounded-xl bg-blue-50/50 hover:bg-blue-50 text-blue-600 font-bold text-xs transition-colors border border-blue-100/10">
                                    <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                                        stroke-width="2.5">
                                ...
                                <!-- Create Officer -->
                                <a href="#"
                                    class="flex items-center gap-3 w-full px-5 py-3.5 rounded-xl bg-purple-50/50 hover:bg-purple-50 text-purple-600 font-bold text-xs transition-colors border border-purple-100/10">
                                    <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                                        stroke-width="2.5">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4" />
                                    </svg>
                                ...
                                <a href="#"
                                    class="flex items-center gap-3 w-full px-5 py-3.5 rounded-xl bg-emerald-50/50 hover:bg-emerald-50 text-emerald-600 font-bold text-xs transition-colors border border-emerald-100/10">
                                    <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                                        stroke-width="2.5">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <!-- New Academic Year -->
                                <a href="#"
                                    class="flex items-center gap-3 w-full px-5 py-3.5 rounded-xl bg-amber-50/50 hover:bg-amber-50 text-amber-700 font-bold text-xs transition-colors border border-amber-100/10">
                                    <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                                        stroke-width="2.5">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <a href="#"
                                    class="flex items-center gap-3 w-full px-5 py-3.5 rounded-xl bg-indigo-50/50 hover:bg-indigo-50 text-indigo-600 font-bold text-xs transition-colors border border-indigo-100/10">
                                    <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                                        stroke-width="2.5">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <!-- View Audit Logs -->
                                <a href="#"
                                    class="flex items-center gap-3 w-full px-5 py-3.5 rounded-xl bg-slate-50 hover:bg-slate-100 text-slate-700 font-bold text-xs transition-colors border border-slate-200/40">
                                    <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                                        stroke-width="2.5">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                            d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
