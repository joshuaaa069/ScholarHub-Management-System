<aside
    ...
    <div class="h-20 flex items-center px-6 gap-3 border-b border-slate-800/30">
        ...
        <div x-show="!sidebarCollapsed" x-transition:enter="transition ease-out duration-200"
            ...
            <span class="text-white font-extrabold text-lg tracking-tight block leading-none">CKC ScholarHub</span>
            <span class="text-[9px] text-slate-500 font-semibold tracking-wider uppercase">System Administrator</span>
        </div>
    </div>
    ...
    <nav class="flex-1 px-4 space-y-1.5 py-2">
        ...
        <a href="{{ route('superadmin.scholarships') }}"
            ...
            <svg class="w-5 h-5 shrink-0 {{ request()->routeIs('superadmin.scholarships') ? 'text-blue-500' : '' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <a href="{{ route('superadmin.academic-years') }}"
            ...
            <svg class="w-5 h-5 shrink-0 {{ request()->routeIs('superadmin.academic-years') ? 'text-blue-500' : '' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <a href="{{ route('superadmin.reports') }}"
            ...
            <svg class="w-5 h-5 shrink-0 {{ request()->routeIs('superadmin.reports') ? 'text-blue-500' : '' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <a href="{{ route('superadmin.audit-logs') }}"
            ...
            <svg class="w-5 h-5 shrink-0 {{ request()->routeIs('superadmin.audit-logs') ? 'text-blue-500' : '' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
